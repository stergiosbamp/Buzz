...
/**
 * Η ΚΛΑΣΗ RoundStopTime ΑΝΑΦΕΡΕΤΑΙ ΣΤΟΝ ΓΥΡΟ ΘΕΡΜΟΜΕΤΡΟ ΚΑΙ
...
public class RoundThermometer extends Round {
     ...
     */
    public RoundThermometer(String n) throws IOException {
        super(n);
    }
    /**
     * Η μέθοδος αυτή υλοποιεί το γύρο ΘΕΡΜΟΜΕΤΡΟ.
     * 
     ...
     * 
     */
    public Question playRoundThermometer() {
        return super.play();
    }
}
