...
/**
 *  Η ΚΛΑΣΗ RoundQuickAnswer ΑΝΑΦΕΡΕΤΑΙ ΣΤΟΝ ΓΥΡΟ ΓΡΗΓΟΡΗ ΑΠΑΝΤΗΣΗ ΚΑΙ ΚΛΗΡΟΝΟΜΕΙ 
...
public class RoundQuickAnswer extends Round {
     ...
     */
    public RoundQuickAnswer(String n) throws IOException {
        super(n);
    }
    /**
     * Η μέθοδος αυτή υλοποιεί το γύρο ΓΡΗΓΟΡΗ ΑΠΑΝΤΗΣΗ.
     * 
     ...
     * 
     */
    public Question playRoundQuickAnswer() {
        return super.play();
    }
